...
table(design_blocked$blockID, design_blocked$respID[design_blocked$qID == 1])
```
...
priors_interactions <- cbc_priors(
  profiles = profiles,
  price = -0.1,                   # Main effect of price
  type = c(0.1, 0.2),             # Main effects of type levels
  freshness = c(0.1, 0.2),        # Main effects of freshness levels
  interactions = list(

...
If you're unsure where to start, you can use the `cbc_suggest_priors()` function to get a starting set of priors. The function prints out suggested code to use for defining a set of priors:

...
1. **Design optimization**: Pass to `cbc_design()` for D-optimal methods. See the [Design](design.html) article for more details.
2. **Choice simulation**: Pass to `cbc_choices()` for realistic choice patterns. See the [Choices](choices.html) article for more details.

...
classoption: dvipsnames # For other colors in xcolors
---

\newcommand{\checkgreen}{\textcolor{Green}{\Checkmark}}
\newcommand{\xred}{\textcolor{red}{\XSolid}}
...
knitr::asis_output('
\begin{table}[ht]
    \caption{Summary of addition options supported by each design method.}
    \vspace{-20pt}
    \begin{center}
    \renewcommand{\arraystretch}{1.1}
        \begin{tabular}{lllll}
            ...
            \midrule
            \code{"random"}     & \checkgreen & \checkgreen & \checkgreen & \xred \\
            \code{"full"}       & \checkgreen & \checkgreen & \checkgreen & \checkgreen \\
            \code{"orthogonal"} & \checkgreen & \xred & \xred & \checkgreen \\
            \code{"dopt"}       & \checkgreen & \xred & \checkgreen & \checkgreen \\
            \code{"CEA"}        & \checkgreen & \xred & \xred & \checkgreen \\
            \code{"Modfed"}     & \checkgreen & \xred & \checkgreen & \checkgreen \\
            \bottomrule[1pt]
        \end{tabular}
    \end{center}
\end{table}

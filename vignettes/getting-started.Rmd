...
2. **Create Priors** → `cbc_priors()` - Specify preference assumptions
3. **Generate Design** → `cbc_design()` - Create choice questions
...
```{r}
# Plot power curves
plot(power_results, type = "power", power_threshold = 0.8)
```

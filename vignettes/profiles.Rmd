...
If some combinations don't make sense, you can remove them. For example, premium apples (Honeycrisp) are rarely sold at lowest prices, so we can add that restriction with `cbc_restrict()`:

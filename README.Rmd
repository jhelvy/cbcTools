...
```
┌─────────┐  ┌─────────┐  ┌─────────┐  ┌─────────┐  ┌─────────┐  ┌─────────┐
│Generate │─▶│ Create  │─▶│Generate │─▶│ Inspect │─▶│Simulate │─▶│ Assess  │
│Profiles │  │ Priors  │  │ Design  │  │ Design  │  │Choices  │  │ Power   │
└─────────┘  └─────────┘  └─────────┘  └─────────┘  └─────────┘  └─────────┘
     │            │            │            │            │            │
cbc_profiles() cbc_priors() cbc_design() cbc_inspect() cbc_choices() cbc_power()
                                         cbc_compare()
```
